[myfirsttssproject2223-eb48] Operating Details
====================================

Generated On: 2024-10-16 18:17:23 UTC
...
.. important::
   ...
   **not be valid if your [myfirsttssproject2223-eb48] container is NOT running**.

.. tip::
   You must have your [myfirsttssproject2223-eb48] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   shubjoshi/myfirsttssproject2223-eb48-amd64 (https://hub.docker.com/r/shubjoshi/myfirsttssproject2223-eb48-amd64)
...
.. important::
   docker run -d -p 56601:56601 -p 54801:54801 -p 33131:33131 \-\-env TSS=0 \-\-env SOLUTIONNAME=myfirsttssproject2223-eb48 \-\-env SOLUTIONDAG=solution_preprocessing_dag-myfirsttssproject2223-eb48 \-\-env GITUSERNAME=joshi-shubham  \-\-env GITREPOURL=https://github.com/joshi-shubham/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=56601  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=54801  \-\-env SOLUTIONVIPERVIZPORT=33131 \-\-env DOCKERUSERNAME='shubjoshi'  \-\-env EXTERNALPORT=36689 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='shubjoshi2056@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  shubjoshi/myfirsttssproject2223-eb48-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=33131
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=56601
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - shubjoshi/myfirsttssproject2223-eb48-amd64
...
It can be accessed by entering: http://localhost:54801
...
.. important::
   http://localhost:33131/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:33131/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:33131/<html file>
...
[myfirsttssproject2223-eb48] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/joshi-shubham/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myfirsttssproject2223-eb48
...
.. important::
   https://myfirsttssproject2223-eb48.readthedocs.io
...
.. important::
   solution_preprocessing_dag-myfirsttssproject2223-eb48
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=56601, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45447, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=37917, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=42151, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=41391, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=35721, HPDEHOST=127.0.1.1, HPDEPORT=36735, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=44475

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6763-myfirsttssproject2223-eb48,solution_preprocessing_dag-myfirsttssproject2223-eb48, python-preprocess-2922-myfirsttssproject2223-eb48,solution_preprocessing_dag-myfirsttssproject2223-eb48, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
